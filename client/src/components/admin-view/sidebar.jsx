import { AlignEndHorizontal, ChartNoAxesCombined, LayoutDashboard, ListOrdered, Menu, MenuIcon, ShoppingBasket } from 'lucide-react'
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
function AdminSidebar({open, setOpen}) {
  ...
  return (
    ...
    <SheetHeader className='border-b'>
      <SheetTitle> <AlignEndHorizontal size={30} /> Admin Panel </SheetTitle>
    </SheetHeader>
